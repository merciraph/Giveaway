...
<template>
    <Card>
        <template #content>
            <DataTable :size="size" sortField="score" :sortOrder="-1" removableSort v-model:filters="filters" :value="tableData" scrollable scrollHeight="45vh" paginator :rows="60" :rowsPerPageOptions="[5, 10, 25, 50, 60, 100, 200]" filterDisplay="menu" :loading="loading"
